...
namespace Northwind.Data
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<ProductAudit9> ProductAudit9s { get; set; } = null!;
        public virtual DbSet<ProductSalesFor1997> ProductSalesFor1997s { get; set; } = null!;
        public virtual DbSet<ProductTrig> ProductTrigs { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=DESKTOP-9RLOF09\\SQL_2022; initial catalog=Northwind; Encrypt=False; TrustServerCertificate=False; trusted_connection=yes");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ProductAudit9>(entity =>
            {
                entity.HasKey(e => e.AuditId)
                    .HasName("PK__ProductA__A17F23B8AF73BF43");
            });
            ...
            modelBuilder.Entity<ProductTrig>(entity =>
            {
                entity.Property(e => e.ProductId).ValueGeneratedOnAdd();
            });
